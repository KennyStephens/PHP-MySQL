...
if (isset($_POST['submit'])) {
    ...
    if(!empty($username) && !empty($password1) && !empty($password2) && ($password1 == $password2)) {
      ...
      $query = "SELECT * FROM capstone_users WHERE username = '$username'";
    ...
    if(mysqli_num_rows($alreadyexists) == 0) {
        // Insert the data
        $query = "INSERT INTO capstone_users (firstname, lastname, username, password, date) VALUES ('$firstname', '$lastname', '$username', SHA('$password1'), NOW())";
